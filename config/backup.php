...
return [
    ...
    // Nonaktifkan jadwal backup otomatis (mis. di lokal) dengan BACKUP_SCHEDULE=false.
    'schedule_enabled' => (bool) env('BACKUP_SCHEDULE', true),
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                // Kode aplikasi ada di git; yang dicadangkan hanya data: dokumen privat (KTP, bukti transfer)
                // dan foto barang. Database dicadangkan terpisah lewat 'databases'.
                'include' => [
        ...
        'destination' => [
             ...
             */
            // Contoh: BACKUP_DISKS=backups,s3 untuk menyimpan salinan di luar server.
